...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in hardware_pb2_grpc.py depends on'
...
class HardwareServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetHardwareResources = channel.unary_unary(
                ...
                response_deserializer=hardware__pb2.HardwareListResponse.FromString,
...
def add_HardwareServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetHardwareResources': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=hardware__pb2.HardwareListResponse.SerializeToString,
            ),
...
class HardwareService(object):
    ...
    def GetHardwareResources(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            hardware__pb2.HardwareListResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
